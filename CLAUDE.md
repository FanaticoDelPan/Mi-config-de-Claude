...
* 📊 **Ritmo de la cuota semanal** (2026-09-23; la semana se reinicia el miércoles 19:00): **16 puntos por día de trabajo, sábado y domingo cuentan como UN día (8 + 8), 4 de margen** → acumulado jue 16 · vie 32 · sáb 40 · dom 48 · lun 64 · mar 80 · mié 96. Es REFERENCIA, no freno: antes de un trabajo grande leé la cuota real (`get_usage`) y, si voy pasado, avisame en una línea con la versión liviana. **1 punto ≈ 59M tokens ≈ 35 USD de lista** (semana 16-23/09, mitad Opus 5 y mitad 5.5: con 5.5 solo rinde más; recalibrar con la próxima medición).
* 🔑 **«tokens» a secas (o «consumo», «cómo voy») = cuánto llevo gastado**, sin preguntar qué quiero decir: `get_usage` (el % real de la semana y de las 5 h) + `medir-consumo-semanal.py` sin argumentos (tokens y subagentes de HOY y de la semana). Contesto en 3-4 líneas: hoy, semana contra la línea de ritmo y cuánto me queda por día.
